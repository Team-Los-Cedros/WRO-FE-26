...
from src.pi5.ronda_cerrada.ronda_nueva import _argumentos, main
...
class PuertaDirectaAlParqueoTests(unittest.TestCase):
    def setUp(self):
        ...
        # El sentido lo fija la prueba, no el JSON de despliegue: ahi es una
        # calibracion de pista y aqui lo que se comprueba es la puerta al
        # parqueo, que debe funcionar en los dos sentidos.
