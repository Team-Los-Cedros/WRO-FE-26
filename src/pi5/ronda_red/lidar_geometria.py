...
class Medicion:
    ...
    __slots__ = ("frontal", "frontal_muro", "izquierda", "derecha", "trasera",
                 ...
                 "clusters_obstaculo", "perfil", "timestamp", "secuencia", "mono",
    ...
    def __init__(self, frontal, izquierda, derecha, trasera,
        ...
        # Identidad del barrido. Cada Medicion es un barrido completo y solo
        # uno: `al_barrido` llama a procesar() de forma sincrona, asi que un
        # barrido que llegue mientras se decide se pierde, no se encola.
        # Sin esto, quien consume clusters no puede distinguir "no ha
        # cambiado nada" de "es la misma lista de hace un ciclo", y acaba
        # tratando una medida vieja como actual.
        self.secuencia = next(_secuencia)
