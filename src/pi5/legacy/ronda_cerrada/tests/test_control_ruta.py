...
from src.pi5.ronda_cerrada.control_ruta import ControlRuta
from src.pi5.ronda_cerrada.modelos import (
    Corredor,
    ResultadoParqueo,
    TrackObstaculo,
)
...
class ControlRutaTests(unittest.TestCase):
    def setUp(self):
        ...
        # Estas pruebas ejercitan la RESOLUCION del sentido, asi que lo fijan
        # ellas en vez de heredarlo del JSON que se despliega. Ese valor es
        # una calibracion de pista -- en la Pi 5 tiene que ser LEFT o RIGHT
        # porque no hay sensor de color de piso -- y una prueba no debe
        # romperse cuando la pista cambia de sentido.
